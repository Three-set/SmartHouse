 ...
 * @see SystemUiHider
 */
public class SampleHomeActivity extends Activity {
	/**
	...
	private Intent loactionService;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		malerDialog = new AlertDialog.Builder(this).setTitle(R.string.sample_home_config).
		// setIcon(R.drawable.ic_launcher).
				setView(new EditText(this)).setPositiveButton(R.string.sample_home_ok, null).setNegativeButton(R.string.sample_home_cancle, null).create();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, 1, 0, R.string.sample_home_exit);
		menu.add(0, 0, 0, R.string.sample_home_config);
		return true;
	}
